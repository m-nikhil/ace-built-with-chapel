ace.define("ace/mode/chapel_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
var ChapelHighlightRules = function() {
    ...
    this.$rules = {
        start: [{
            ...
            regex: /\b(?:align|as|atomic|begin|break|by|class|cobegin|coforall|continue|delete|dmapped|do|else|enum|except|export|extern|for|forall|if|index|inline|iter|label|lambda|let|local|module|new|noinit|on|only|otherwise|pragma|private|proc|public|record|reduce|require|return|scan|select|serial|then|union|use|var|when|where|while|with|yield|zip)\b/
        }, {
...
ace.define("ace/mode/chapel",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/chapel_highlight_rules","ace/mode/folding/cstyle"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var ChapelHighlightRules = require("./chapel_highlight_rules").ChapelHighlightRules;
